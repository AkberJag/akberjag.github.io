<template>
    <div class="relative h-screen overflow-hidden bg-slate-100 dark:bg-[#24292e] transition-colors duration-700">
        ...
        <NavigationDots :sections="portfolioData.sections" :currentSection="currentSection"
            @navigate="navigateToSection" class="fixed right-4 top-1/2 transform -translate-y-1/2 z-20" />
